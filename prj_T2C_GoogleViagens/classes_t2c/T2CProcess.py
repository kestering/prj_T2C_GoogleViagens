...
from prj_T2C_GoogleViagens.classes.ColetaPrecosCidades import TravelExplore
...
class T2CProcess:
    ...
    def execute(self, arg_tplQueueItem:tuple):
        ...
        var_listDadosViagem = var_clssTravelExplore.pesquisar_viagem(arg_listViagem = self.var_listDadosViagem,arg_strCidadeOrigem = "São Paulo",arg_strCidadeDirecao = var_strPais, arg_strDataPartida = "20/08/2025", arg_strDataVolta = "23/08/2025")
